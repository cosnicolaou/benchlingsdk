...
// DnaSequenceWithEntityType struct for DnaSequenceWithEntityType
...
func NewDnaSequenceWithEntityType() *DnaSequenceWithEntityType {
	this := DnaSequenceWithEntityType{}
	return &this
}
...
func (o *DnaSequenceWithEntityType) SetArchiveRecordNil() {
...
func (o *DnaSequenceWithEntityType) SetEntityRegistryIdNil() {
...
func (o *DnaSequenceWithEntityType) SetFolderIdNil() {
	o.FolderId.Set(nil)
}
...
func (o *DnaSequenceWithEntityType) SetRegistrationOriginNil() {
...
func (o *DnaSequenceWithEntityType) SetRegistryIdNil() {
...
func (o *DnaSequenceWithEntityType) SetSchemaNil() {
	o.Schema.Set(nil)
}
...
func (o DnaSequenceWithEntityType) MarshalJSON() ([]byte, error) {
...
type NullableDnaSequenceWithEntityType struct {
	value *DnaSequenceWithEntityType
	isSet bool
}

func (v NullableDnaSequenceWithEntityType) Get() *DnaSequenceWithEntityType {
	return v.value
}

func (v *NullableDnaSequenceWithEntityType) Set(val *DnaSequenceWithEntityType) {
	v.value = val
	v.isSet = true
}

func (v NullableDnaSequenceWithEntityType) IsSet() bool {
	return v.isSet
}

func (v *NullableDnaSequenceWithEntityType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnaSequenceWithEntityType(val *DnaSequenceWithEntityType) *NullableDnaSequenceWithEntityType {
	return &NullableDnaSequenceWithEntityType{value: val, isSet: true}
}

func (v NullableDnaSequenceWithEntityType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnaSequenceWithEntityType) UnmarshalJSON(src []byte) error {
	v.isSet = true
