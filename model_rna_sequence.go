...
// RnaSequence struct for RnaSequence
...
func (o *RnaSequence) SetArchiveRecordNil() {
...
func (o *RnaSequence) SetEntityRegistryIdNil() {
...
func (o *RnaSequence) SetFolderIdNil() {
	o.FolderId.Set(nil)
}
...
func (o *RnaSequence) SetRegistrationOriginNil() {
...
func (o *RnaSequence) SetRegistryIdNil() {
...
func (o *RnaSequence) SetSchemaNil() {
	o.Schema.Set(nil)
}
...
func (o RnaSequence) MarshalJSON() ([]byte, error) {
...
type NullableRnaSequence struct {
	value *RnaSequence
	isSet bool
}

func (v NullableRnaSequence) Get() *RnaSequence {
	return v.value
}

func (v *NullableRnaSequence) Set(val *RnaSequence) {
	v.value = val
	v.isSet = true
}

func (v NullableRnaSequence) IsSet() bool {
	return v.isSet
}

func (v *NullableRnaSequence) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRnaSequence(val *RnaSequence) *NullableRnaSequence {
	return &NullableRnaSequence{value: val, isSet: true}
}

func (v NullableRnaSequence) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRnaSequence) UnmarshalJSON(src []byte) error {
	v.isSet = true
