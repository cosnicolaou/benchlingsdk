...
// CustomEntityCreator struct for CustomEntityCreator
type CustomEntityCreator struct {
...
func (o CustomEntityCreator) MarshalJSON() ([]byte, error) {
...
type NullableCustomEntityCreator struct {
	value *CustomEntityCreator
	isSet bool
}

func (v NullableCustomEntityCreator) Get() *CustomEntityCreator {
	return v.value
}

func (v *NullableCustomEntityCreator) Set(val *CustomEntityCreator) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomEntityCreator) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomEntityCreator) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomEntityCreator(val *CustomEntityCreator) *NullableCustomEntityCreator {
	return &NullableCustomEntityCreator{value: val, isSet: true}
}

func (v NullableCustomEntityCreator) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomEntityCreator) UnmarshalJSON(src []byte) error {
	v.isSet = true
