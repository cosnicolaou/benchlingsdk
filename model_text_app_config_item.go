...
// TextAppConfigItem struct for TextAppConfigItem
...
func (o *TextAppConfigItem) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o TextAppConfigItem) MarshalJSON() ([]byte, error) {
...
type NullableTextAppConfigItem struct {
	value *TextAppConfigItem
	isSet bool
}

func (v NullableTextAppConfigItem) Get() *TextAppConfigItem {
	return v.value
}

func (v *NullableTextAppConfigItem) Set(val *TextAppConfigItem) {
	v.value = val
	v.isSet = true
}

func (v NullableTextAppConfigItem) IsSet() bool {
	return v.isSet
}

func (v *NullableTextAppConfigItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTextAppConfigItem(val *TextAppConfigItem) *NullableTextAppConfigItem {
	return &NullableTextAppConfigItem{value: val, isSet: true}
}

func (v NullableTextAppConfigItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTextAppConfigItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
