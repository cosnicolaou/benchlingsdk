...
// AutofillPartsAsyncTask struct for AutofillPartsAsyncTask
...
func (o AutofillPartsAsyncTask) MarshalJSON() ([]byte, error) {
...
type NullableAutofillPartsAsyncTask struct {
	value *AutofillPartsAsyncTask
	isSet bool
}

func (v NullableAutofillPartsAsyncTask) Get() *AutofillPartsAsyncTask {
	return v.value
}

func (v *NullableAutofillPartsAsyncTask) Set(val *AutofillPartsAsyncTask) {
	v.value = val
	v.isSet = true
}

func (v NullableAutofillPartsAsyncTask) IsSet() bool {
	return v.isSet
}

func (v *NullableAutofillPartsAsyncTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutofillPartsAsyncTask(val *AutofillPartsAsyncTask) *NullableAutofillPartsAsyncTask {
	return &NullableAutofillPartsAsyncTask{value: val, isSet: true}
}

func (v NullableAutofillPartsAsyncTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutofillPartsAsyncTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
