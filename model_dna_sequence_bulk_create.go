...
// DnaSequenceBulkCreate struct for DnaSequenceBulkCreate
type DnaSequenceBulkCreate struct {
...
func (o DnaSequenceBulkCreate) MarshalJSON() ([]byte, error) {
...
type NullableDnaSequenceBulkCreate struct {
	value *DnaSequenceBulkCreate
	isSet bool
}

func (v NullableDnaSequenceBulkCreate) Get() *DnaSequenceBulkCreate {
	return v.value
}

func (v *NullableDnaSequenceBulkCreate) Set(val *DnaSequenceBulkCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableDnaSequenceBulkCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableDnaSequenceBulkCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnaSequenceBulkCreate(val *DnaSequenceBulkCreate) *NullableDnaSequenceBulkCreate {
	return &NullableDnaSequenceBulkCreate{value: val, isSet: true}
}

func (v NullableDnaSequenceBulkCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnaSequenceBulkCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
