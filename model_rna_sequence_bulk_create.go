...
// RnaSequenceBulkCreate struct for RnaSequenceBulkCreate
type RnaSequenceBulkCreate struct {
...
func (o RnaSequenceBulkCreate) MarshalJSON() ([]byte, error) {
...
type NullableRnaSequenceBulkCreate struct {
	value *RnaSequenceBulkCreate
	isSet bool
}

func (v NullableRnaSequenceBulkCreate) Get() *RnaSequenceBulkCreate {
	return v.value
}

func (v *NullableRnaSequenceBulkCreate) Set(val *RnaSequenceBulkCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableRnaSequenceBulkCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableRnaSequenceBulkCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRnaSequenceBulkCreate(val *RnaSequenceBulkCreate) *NullableRnaSequenceBulkCreate {
	return &NullableRnaSequenceBulkCreate{value: val, isSet: true}
}

func (v NullableRnaSequenceBulkCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRnaSequenceBulkCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
