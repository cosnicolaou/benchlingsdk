...
// EntryUpdatedFieldsEventAllOf struct for EntryUpdatedFieldsEventAllOf
type EntryUpdatedFieldsEventAllOf struct {
...
func NewEntryUpdatedFieldsEventAllOf() *EntryUpdatedFieldsEventAllOf {
	this := EntryUpdatedFieldsEventAllOf{}
	return &this
}
...
func (o EntryUpdatedFieldsEventAllOf) MarshalJSON() ([]byte, error) {
...
type NullableEntryUpdatedFieldsEventAllOf struct {
	value *EntryUpdatedFieldsEventAllOf
	isSet bool
}

func (v NullableEntryUpdatedFieldsEventAllOf) Get() *EntryUpdatedFieldsEventAllOf {
	return v.value
}

func (v *NullableEntryUpdatedFieldsEventAllOf) Set(val *EntryUpdatedFieldsEventAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableEntryUpdatedFieldsEventAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableEntryUpdatedFieldsEventAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntryUpdatedFieldsEventAllOf(val *EntryUpdatedFieldsEventAllOf) *NullableEntryUpdatedFieldsEventAllOf {
	return &NullableEntryUpdatedFieldsEventAllOf{value: val, isSet: true}
}

func (v NullableEntryUpdatedFieldsEventAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntryUpdatedFieldsEventAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
