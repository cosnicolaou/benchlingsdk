...
// BoxUpdate struct for BoxUpdate
...
func (o BoxUpdate) MarshalJSON() ([]byte, error) {
...
type NullableBoxUpdate struct {
	value *BoxUpdate
	isSet bool
}

func (v NullableBoxUpdate) Get() *BoxUpdate {
	return v.value
}

func (v *NullableBoxUpdate) Set(val *BoxUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableBoxUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableBoxUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBoxUpdate(val *BoxUpdate) *NullableBoxUpdate {
	return &NullableBoxUpdate{value: val, isSet: true}
}

func (v NullableBoxUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBoxUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
