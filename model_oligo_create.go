...
// OligoCreate struct for OligoCreate
...
func (o OligoCreate) MarshalJSON() ([]byte, error) {
...
type NullableOligoCreate struct {
	value *OligoCreate
	isSet bool
}

func (v NullableOligoCreate) Get() *OligoCreate {
	return v.value
}

func (v *NullableOligoCreate) Set(val *OligoCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableOligoCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableOligoCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOligoCreate(val *OligoCreate) *NullableOligoCreate {
	return &NullableOligoCreate{value: val, isSet: true}
}

func (v NullableOligoCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOligoCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
