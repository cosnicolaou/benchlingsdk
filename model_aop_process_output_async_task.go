...
// AOPProcessOutputAsyncTask struct for AOPProcessOutputAsyncTask
...
func NewAOPProcessOutputAsyncTask(status string) *AOPProcessOutputAsyncTask {
	this := AOPProcessOutputAsyncTask{}
	this.Status = status
	return &this
}
...
func (o AOPProcessOutputAsyncTask) MarshalJSON() ([]byte, error) {
...
type NullableAOPProcessOutputAsyncTask struct {
	value *AOPProcessOutputAsyncTask
	isSet bool
}

func (v NullableAOPProcessOutputAsyncTask) Get() *AOPProcessOutputAsyncTask {
	return v.value
}

func (v *NullableAOPProcessOutputAsyncTask) Set(val *AOPProcessOutputAsyncTask) {
	v.value = val
	v.isSet = true
}

func (v NullableAOPProcessOutputAsyncTask) IsSet() bool {
	return v.isSet
}

func (v *NullableAOPProcessOutputAsyncTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAOPProcessOutputAsyncTask(val *AOPProcessOutputAsyncTask) *NullableAOPProcessOutputAsyncTask {
	return &NullableAOPProcessOutputAsyncTask{value: val, isSet: true}
}

func (v NullableAOPProcessOutputAsyncTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAOPProcessOutputAsyncTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
