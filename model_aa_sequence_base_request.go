...
// AaSequenceBaseRequest struct for AaSequenceBaseRequest
...
func (o AaSequenceBaseRequest) MarshalJSON() ([]byte, error) {
...
type NullableAaSequenceBaseRequest struct {
	value *AaSequenceBaseRequest
	isSet bool
}

func (v NullableAaSequenceBaseRequest) Get() *AaSequenceBaseRequest {
	return v.value
}

func (v *NullableAaSequenceBaseRequest) Set(val *AaSequenceBaseRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAaSequenceBaseRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAaSequenceBaseRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAaSequenceBaseRequest(val *AaSequenceBaseRequest) *NullableAaSequenceBaseRequest {
	return &NullableAaSequenceBaseRequest{value: val, isSet: true}
}

func (v NullableAaSequenceBaseRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAaSequenceBaseRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
