...
// BulkUpdateContainersAsyncTask struct for BulkUpdateContainersAsyncTask
...
func NewBulkUpdateContainersAsyncTask(status string) *BulkUpdateContainersAsyncTask {
	this := BulkUpdateContainersAsyncTask{}
	this.Status = status
	return &this
}
...
func (o BulkUpdateContainersAsyncTask) MarshalJSON() ([]byte, error) {
...
type NullableBulkUpdateContainersAsyncTask struct {
	value *BulkUpdateContainersAsyncTask
	isSet bool
}

func (v NullableBulkUpdateContainersAsyncTask) Get() *BulkUpdateContainersAsyncTask {
	return v.value
}

func (v *NullableBulkUpdateContainersAsyncTask) Set(val *BulkUpdateContainersAsyncTask) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkUpdateContainersAsyncTask) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkUpdateContainersAsyncTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkUpdateContainersAsyncTask(val *BulkUpdateContainersAsyncTask) *NullableBulkUpdateContainersAsyncTask {
	return &NullableBulkUpdateContainersAsyncTask{value: val, isSet: true}
}

func (v NullableBulkUpdateContainersAsyncTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkUpdateContainersAsyncTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
