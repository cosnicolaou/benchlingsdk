...
// PartySummary struct for PartySummary
...
func (o PartySummary) MarshalJSON() ([]byte, error) {
...
type NullablePartySummary struct {
	value *PartySummary
	isSet bool
}

func (v NullablePartySummary) Get() *PartySummary {
	return v.value
}

func (v *NullablePartySummary) Set(val *PartySummary) {
	v.value = val
	v.isSet = true
}

func (v NullablePartySummary) IsSet() bool {
	return v.isSet
}

func (v *NullablePartySummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartySummary(val *PartySummary) *NullablePartySummary {
	return &NullablePartySummary{value: val, isSet: true}
}

func (v NullablePartySummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartySummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
