...
// CreateTemplateAlignmentAsyncTask struct for CreateTemplateAlignmentAsyncTask
...
func NewCreateTemplateAlignmentAsyncTask(status string) *CreateTemplateAlignmentAsyncTask {
	this := CreateTemplateAlignmentAsyncTask{}
	this.Status = status
	return &this
}
...
func (o CreateTemplateAlignmentAsyncTask) MarshalJSON() ([]byte, error) {
...
type NullableCreateTemplateAlignmentAsyncTask struct {
	value *CreateTemplateAlignmentAsyncTask
	isSet bool
}

func (v NullableCreateTemplateAlignmentAsyncTask) Get() *CreateTemplateAlignmentAsyncTask {
	return v.value
}

func (v *NullableCreateTemplateAlignmentAsyncTask) Set(val *CreateTemplateAlignmentAsyncTask) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTemplateAlignmentAsyncTask) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTemplateAlignmentAsyncTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTemplateAlignmentAsyncTask(val *CreateTemplateAlignmentAsyncTask) *NullableCreateTemplateAlignmentAsyncTask {
	return &NullableCreateTemplateAlignmentAsyncTask{value: val, isSet: true}
}

func (v NullableCreateTemplateAlignmentAsyncTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTemplateAlignmentAsyncTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
