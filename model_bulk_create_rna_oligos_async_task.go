...
// BulkCreateRnaOligosAsyncTask struct for BulkCreateRnaOligosAsyncTask
...
func NewBulkCreateRnaOligosAsyncTask(status string) *BulkCreateRnaOligosAsyncTask {
	this := BulkCreateRnaOligosAsyncTask{}
	this.Status = status
	return &this
}
...
func (o BulkCreateRnaOligosAsyncTask) MarshalJSON() ([]byte, error) {
...
type NullableBulkCreateRnaOligosAsyncTask struct {
	value *BulkCreateRnaOligosAsyncTask
	isSet bool
}

func (v NullableBulkCreateRnaOligosAsyncTask) Get() *BulkCreateRnaOligosAsyncTask {
	return v.value
}

func (v *NullableBulkCreateRnaOligosAsyncTask) Set(val *BulkCreateRnaOligosAsyncTask) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkCreateRnaOligosAsyncTask) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkCreateRnaOligosAsyncTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkCreateRnaOligosAsyncTask(val *BulkCreateRnaOligosAsyncTask) *NullableBulkCreateRnaOligosAsyncTask {
	return &NullableBulkCreateRnaOligosAsyncTask{value: val, isSet: true}
}

func (v NullableBulkCreateRnaOligosAsyncTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkCreateRnaOligosAsyncTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
