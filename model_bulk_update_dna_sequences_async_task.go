...
// BulkUpdateDnaSequencesAsyncTask struct for BulkUpdateDnaSequencesAsyncTask
...
func NewBulkUpdateDnaSequencesAsyncTask(status string) *BulkUpdateDnaSequencesAsyncTask {
	this := BulkUpdateDnaSequencesAsyncTask{}
	this.Status = status
	return &this
}
...
func (o BulkUpdateDnaSequencesAsyncTask) MarshalJSON() ([]byte, error) {
...
type NullableBulkUpdateDnaSequencesAsyncTask struct {
	value *BulkUpdateDnaSequencesAsyncTask
	isSet bool
}

func (v NullableBulkUpdateDnaSequencesAsyncTask) Get() *BulkUpdateDnaSequencesAsyncTask {
	return v.value
}

func (v *NullableBulkUpdateDnaSequencesAsyncTask) Set(val *BulkUpdateDnaSequencesAsyncTask) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkUpdateDnaSequencesAsyncTask) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkUpdateDnaSequencesAsyncTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkUpdateDnaSequencesAsyncTask(val *BulkUpdateDnaSequencesAsyncTask) *NullableBulkUpdateDnaSequencesAsyncTask {
	return &NullableBulkUpdateDnaSequencesAsyncTask{value: val, isSet: true}
}

func (v NullableBulkUpdateDnaSequencesAsyncTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkUpdateDnaSequencesAsyncTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
