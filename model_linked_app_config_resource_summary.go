...
// LinkedAppConfigResourceSummary struct for LinkedAppConfigResourceSummary
...
func NewLinkedAppConfigResourceSummary() *LinkedAppConfigResourceSummary {
	this := LinkedAppConfigResourceSummary{}
	return &this
}
...
func (o LinkedAppConfigResourceSummary) MarshalJSON() ([]byte, error) {
...
type NullableLinkedAppConfigResourceSummary struct {
	value *LinkedAppConfigResourceSummary
	isSet bool
}

func (v NullableLinkedAppConfigResourceSummary) Get() *LinkedAppConfigResourceSummary {
	return v.value
}

func (v *NullableLinkedAppConfigResourceSummary) Set(val *LinkedAppConfigResourceSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkedAppConfigResourceSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkedAppConfigResourceSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkedAppConfigResourceSummary(val *LinkedAppConfigResourceSummary) *NullableLinkedAppConfigResourceSummary {
	return &NullableLinkedAppConfigResourceSummary{value: val, isSet: true}
}

func (v NullableLinkedAppConfigResourceSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkedAppConfigResourceSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
