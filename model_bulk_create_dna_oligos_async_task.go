...
// BulkCreateDnaOligosAsyncTask struct for BulkCreateDnaOligosAsyncTask
...
func NewBulkCreateDnaOligosAsyncTask(status string) *BulkCreateDnaOligosAsyncTask {
	this := BulkCreateDnaOligosAsyncTask{}
	this.Status = status
	return &this
}
...
func (o BulkCreateDnaOligosAsyncTask) MarshalJSON() ([]byte, error) {
...
type NullableBulkCreateDnaOligosAsyncTask struct {
	value *BulkCreateDnaOligosAsyncTask
	isSet bool
}

func (v NullableBulkCreateDnaOligosAsyncTask) Get() *BulkCreateDnaOligosAsyncTask {
	return v.value
}

func (v *NullableBulkCreateDnaOligosAsyncTask) Set(val *BulkCreateDnaOligosAsyncTask) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkCreateDnaOligosAsyncTask) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkCreateDnaOligosAsyncTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkCreateDnaOligosAsyncTask(val *BulkCreateDnaOligosAsyncTask) *NullableBulkCreateDnaOligosAsyncTask {
	return &NullableBulkCreateDnaOligosAsyncTask{value: val, isSet: true}
}

func (v NullableBulkCreateDnaOligosAsyncTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkCreateDnaOligosAsyncTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
