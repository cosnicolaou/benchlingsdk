...
// EntryCreator UserSummary Resource of the user who created the entry
...
func (o EntryCreator) MarshalJSON() ([]byte, error) {
...
type NullableEntryCreator struct {
	value *EntryCreator
	isSet bool
}

func (v NullableEntryCreator) Get() *EntryCreator {
	return v.value
}

func (v *NullableEntryCreator) Set(val *EntryCreator) {
	v.value = val
	v.isSet = true
}

func (v NullableEntryCreator) IsSet() bool {
	return v.isSet
}

func (v *NullableEntryCreator) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntryCreator(val *EntryCreator) *NullableEntryCreator {
	return &NullableEntryCreator{value: val, isSet: true}
}

func (v NullableEntryCreator) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntryCreator) UnmarshalJSON(src []byte) error {
	v.isSet = true
