...
// WorkflowTaskUpdatedStatusEventAllOf struct for WorkflowTaskUpdatedStatusEventAllOf
type WorkflowTaskUpdatedStatusEventAllOf struct {
...
func NewWorkflowTaskUpdatedStatusEventAllOf() *WorkflowTaskUpdatedStatusEventAllOf {
	this := WorkflowTaskUpdatedStatusEventAllOf{}
	return &this
}
...
func (o WorkflowTaskUpdatedStatusEventAllOf) MarshalJSON() ([]byte, error) {
...
type NullableWorkflowTaskUpdatedStatusEventAllOf struct {
	value *WorkflowTaskUpdatedStatusEventAllOf
	isSet bool
}

func (v NullableWorkflowTaskUpdatedStatusEventAllOf) Get() *WorkflowTaskUpdatedStatusEventAllOf {
	return v.value
}

func (v *NullableWorkflowTaskUpdatedStatusEventAllOf) Set(val *WorkflowTaskUpdatedStatusEventAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowTaskUpdatedStatusEventAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowTaskUpdatedStatusEventAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowTaskUpdatedStatusEventAllOf(val *WorkflowTaskUpdatedStatusEventAllOf) *NullableWorkflowTaskUpdatedStatusEventAllOf {
	return &NullableWorkflowTaskUpdatedStatusEventAllOf{value: val, isSet: true}
}

func (v NullableWorkflowTaskUpdatedStatusEventAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowTaskUpdatedStatusEventAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
