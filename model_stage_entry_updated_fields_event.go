...
// StageEntryUpdatedFieldsEvent struct for StageEntryUpdatedFieldsEvent
...
func NewStageEntryUpdatedFieldsEvent() *StageEntryUpdatedFieldsEvent {
	this := StageEntryUpdatedFieldsEvent{}
	return &this
}
...
func (o *StageEntryUpdatedFieldsEvent) SetSchemaNil() {
	o.Schema.Set(nil)
}
...
func (o StageEntryUpdatedFieldsEvent) MarshalJSON() ([]byte, error) {
...
type NullableStageEntryUpdatedFieldsEvent struct {
	value *StageEntryUpdatedFieldsEvent
	isSet bool
}

func (v NullableStageEntryUpdatedFieldsEvent) Get() *StageEntryUpdatedFieldsEvent {
	return v.value
}

func (v *NullableStageEntryUpdatedFieldsEvent) Set(val *StageEntryUpdatedFieldsEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableStageEntryUpdatedFieldsEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableStageEntryUpdatedFieldsEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStageEntryUpdatedFieldsEvent(val *StageEntryUpdatedFieldsEvent) *NullableStageEntryUpdatedFieldsEvent {
	return &NullableStageEntryUpdatedFieldsEvent{value: val, isSet: true}
}

func (v NullableStageEntryUpdatedFieldsEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStageEntryUpdatedFieldsEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
