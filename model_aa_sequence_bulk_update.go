...
// AaSequenceBulkUpdate struct for AaSequenceBulkUpdate
...
func (o AaSequenceBulkUpdate) MarshalJSON() ([]byte, error) {
...
type NullableAaSequenceBulkUpdate struct {
	value *AaSequenceBulkUpdate
	isSet bool
}

func (v NullableAaSequenceBulkUpdate) Get() *AaSequenceBulkUpdate {
	return v.value
}

func (v *NullableAaSequenceBulkUpdate) Set(val *AaSequenceBulkUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableAaSequenceBulkUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableAaSequenceBulkUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAaSequenceBulkUpdate(val *AaSequenceBulkUpdate) *NullableAaSequenceBulkUpdate {
	return &NullableAaSequenceBulkUpdate{value: val, isSet: true}
}

func (v NullableAaSequenceBulkUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAaSequenceBulkUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
