...
// BaseAssaySchemaAllOfOrganization struct for BaseAssaySchemaAllOfOrganization
type BaseAssaySchemaAllOfOrganization struct {
...
func NewBaseAssaySchemaAllOfOrganization() *BaseAssaySchemaAllOfOrganization {
	this := BaseAssaySchemaAllOfOrganization{}
	return &this
}
...
func (o BaseAssaySchemaAllOfOrganization) MarshalJSON() ([]byte, error) {
...
type NullableBaseAssaySchemaAllOfOrganization struct {
	value *BaseAssaySchemaAllOfOrganization
	isSet bool
}

func (v NullableBaseAssaySchemaAllOfOrganization) Get() *BaseAssaySchemaAllOfOrganization {
	return v.value
}

func (v *NullableBaseAssaySchemaAllOfOrganization) Set(val *BaseAssaySchemaAllOfOrganization) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseAssaySchemaAllOfOrganization) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseAssaySchemaAllOfOrganization) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseAssaySchemaAllOfOrganization(val *BaseAssaySchemaAllOfOrganization) *NullableBaseAssaySchemaAllOfOrganization {
	return &NullableBaseAssaySchemaAllOfOrganization{value: val, isSet: true}
}

func (v NullableBaseAssaySchemaAllOfOrganization) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseAssaySchemaAllOfOrganization) UnmarshalJSON(src []byte) error {
	v.isSet = true
