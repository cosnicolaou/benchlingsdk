...
// OligoBaseRequest struct for OligoBaseRequest
...
func (o OligoBaseRequest) MarshalJSON() ([]byte, error) {
...
type NullableOligoBaseRequest struct {
	value *OligoBaseRequest
	isSet bool
}

func (v NullableOligoBaseRequest) Get() *OligoBaseRequest {
	return v.value
}

func (v *NullableOligoBaseRequest) Set(val *OligoBaseRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableOligoBaseRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableOligoBaseRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOligoBaseRequest(val *OligoBaseRequest) *NullableOligoBaseRequest {
	return &NullableOligoBaseRequest{value: val, isSet: true}
}

func (v NullableOligoBaseRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOligoBaseRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
