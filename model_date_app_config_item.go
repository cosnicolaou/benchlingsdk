...
// DateAppConfigItem struct for DateAppConfigItem
...
func (o *DateAppConfigItem) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o DateAppConfigItem) MarshalJSON() ([]byte, error) {
...
type NullableDateAppConfigItem struct {
	value *DateAppConfigItem
	isSet bool
}

func (v NullableDateAppConfigItem) Get() *DateAppConfigItem {
	return v.value
}

func (v *NullableDateAppConfigItem) Set(val *DateAppConfigItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDateAppConfigItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDateAppConfigItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDateAppConfigItem(val *DateAppConfigItem) *NullableDateAppConfigItem {
	return &NullableDateAppConfigItem{value: val, isSet: true}
}

func (v NullableDateAppConfigItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDateAppConfigItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
