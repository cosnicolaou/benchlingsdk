...
func (r ApiGetTaskRequest) Execute() (*GetTask200Response, *http.Response, error) {
...
func (a *TasksApiService) GetTaskExecute(r ApiGetTaskRequest) (*GetTask200Response, *http.Response, error) {
	var (
