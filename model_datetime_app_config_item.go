...
// DatetimeAppConfigItem struct for DatetimeAppConfigItem
...
func (o *DatetimeAppConfigItem) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o DatetimeAppConfigItem) MarshalJSON() ([]byte, error) {
...
type NullableDatetimeAppConfigItem struct {
	value *DatetimeAppConfigItem
	isSet bool
}

func (v NullableDatetimeAppConfigItem) Get() *DatetimeAppConfigItem {
	return v.value
}

func (v *NullableDatetimeAppConfigItem) Set(val *DatetimeAppConfigItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDatetimeAppConfigItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDatetimeAppConfigItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatetimeAppConfigItem(val *DatetimeAppConfigItem) *NullableDatetimeAppConfigItem {
	return &NullableDatetimeAppConfigItem{value: val, isSet: true}
}

func (v NullableDatetimeAppConfigItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatetimeAppConfigItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
