...
// EntryTemplateCreator UserSummary Resource of the user who created the template
type EntryTemplateCreator struct {
...
func (o EntryTemplateCreator) MarshalJSON() ([]byte, error) {
...
type NullableEntryTemplateCreator struct {
	value *EntryTemplateCreator
	isSet bool
}

func (v NullableEntryTemplateCreator) Get() *EntryTemplateCreator {
	return v.value
}

func (v *NullableEntryTemplateCreator) Set(val *EntryTemplateCreator) {
	v.value = val
	v.isSet = true
}

func (v NullableEntryTemplateCreator) IsSet() bool {
	return v.isSet
}

func (v *NullableEntryTemplateCreator) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntryTemplateCreator(val *EntryTemplateCreator) *NullableEntryTemplateCreator {
	return &NullableEntryTemplateCreator{value: val, isSet: true}
}

func (v NullableEntryTemplateCreator) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntryTemplateCreator) UnmarshalJSON(src []byte) error {
	v.isSet = true
