...
// AssayResultCreator UserSummary Resource of who created the request
type AssayResultCreator struct {
...
func (o AssayResultCreator) MarshalJSON() ([]byte, error) {
...
type NullableAssayResultCreator struct {
	value *AssayResultCreator
	isSet bool
}

func (v NullableAssayResultCreator) Get() *AssayResultCreator {
	return v.value
}

func (v *NullableAssayResultCreator) Set(val *AssayResultCreator) {
	v.value = val
	v.isSet = true
}

func (v NullableAssayResultCreator) IsSet() bool {
	return v.isSet
}

func (v *NullableAssayResultCreator) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssayResultCreator(val *AssayResultCreator) *NullableAssayResultCreator {
	return &NullableAssayResultCreator{value: val, isSet: true}
}

func (v NullableAssayResultCreator) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssayResultCreator) UnmarshalJSON(src []byte) error {
	v.isSet = true
