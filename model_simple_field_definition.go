...
// SimpleFieldDefinition struct for SimpleFieldDefinition
...
func (o *SimpleFieldDefinition) SetArchiveRecordNil() {
...
func (o SimpleFieldDefinition) MarshalJSON() ([]byte, error) {
...
type NullableSimpleFieldDefinition struct {
	value *SimpleFieldDefinition
	isSet bool
}

func (v NullableSimpleFieldDefinition) Get() *SimpleFieldDefinition {
	return v.value
}

func (v *NullableSimpleFieldDefinition) Set(val *SimpleFieldDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableSimpleFieldDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableSimpleFieldDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSimpleFieldDefinition(val *SimpleFieldDefinition) *NullableSimpleFieldDefinition {
	return &NullableSimpleFieldDefinition{value: val, isSet: true}
}

func (v NullableSimpleFieldDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSimpleFieldDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
