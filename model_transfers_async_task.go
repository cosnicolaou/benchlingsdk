...
// TransfersAsyncTask struct for TransfersAsyncTask
...
func (o TransfersAsyncTask) MarshalJSON() ([]byte, error) {
...
type NullableTransfersAsyncTask struct {
	value *TransfersAsyncTask
	isSet bool
}

func (v NullableTransfersAsyncTask) Get() *TransfersAsyncTask {
	return v.value
}

func (v *NullableTransfersAsyncTask) Set(val *TransfersAsyncTask) {
	v.value = val
	v.isSet = true
}

func (v NullableTransfersAsyncTask) IsSet() bool {
	return v.isSet
}

func (v *NullableTransfersAsyncTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransfersAsyncTask(val *TransfersAsyncTask) *NullableTransfersAsyncTask {
	return &NullableTransfersAsyncTask{value: val, isSet: true}
}

func (v NullableTransfersAsyncTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransfersAsyncTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
