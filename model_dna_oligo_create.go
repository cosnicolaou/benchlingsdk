...
// DnaOligoCreate struct for DnaOligoCreate
...
func (o DnaOligoCreate) MarshalJSON() ([]byte, error) {
...
type NullableDnaOligoCreate struct {
	value *DnaOligoCreate
	isSet bool
}

func (v NullableDnaOligoCreate) Get() *DnaOligoCreate {
	return v.value
}

func (v *NullableDnaOligoCreate) Set(val *DnaOligoCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableDnaOligoCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableDnaOligoCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnaOligoCreate(val *DnaOligoCreate) *NullableDnaOligoCreate {
	return &NullableDnaOligoCreate{value: val, isSet: true}
}

func (v NullableDnaOligoCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnaOligoCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
